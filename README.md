...
>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/1.png?raw=true>)

>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/2.png?raw=true>)
...
- `images`: `ghcr.io/gn4r4/publish-packages/game` — шлях до сховища образу.
  ...
  publish:
    ...
    steps:
      ...
      - name: Docker meta
        ...
        with:
          images: ghcr.io/gn4r4/publish-packages/game
          tags: type=sha
...
>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/3.png?raw=true>)
...
>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/4.png?raw=true>)

>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/5.png?raw=true>)
...
>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/6.png?raw=true>)

1. `Login`: Виконано авторизацію в терміналі через команду 

```bash
docker login ghcr.io -u gn4r4
```

>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/7.png?raw=true>)

2. `Pull`: Завантажено створений образ на локальну машину: 

```bash
docker pull ghcr.io/gn4r4/publish-packages/game:sha-f36b60e
```

>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/8.png?raw=true>)
...
```bash
docker run -dp 8080:80 --rm ghcr.io/gn4r4/publish-packages/game:sha-f36b60e
```

>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/9.png?raw=true>)
...
>![placeholder](<https://github.com/gn4r4/skills-publish-packages/blob/main/images/10.png?raw=true>)
